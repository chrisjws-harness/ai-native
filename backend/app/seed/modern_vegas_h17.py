"""
Modern Vegas H17 — 6-deck basic strategy.
Dealer hits on soft 17, double after split allowed, late surrender allowed.
...
RULESET_META = {
    "name": "Modern Vegas H17",
    "deck_count": 6,
    "dealer_hits_s17": True,
    "das_allowed": True,
    "surrender": "late",
    "description": "Modern Vegas rules. 6-deck shoe, dealer hits soft 17, double after split allowed, late surrender.",
}
